...
public class JwtService {
  ...
  public JwtSession registerJwtSession(UserResponse userDto) {
    ...
    JwtSession jwtSession = new JwtSession(
        userDto.id(), accessJwtObject.token(),
  ...
  public JwtObject parse(String token) {
    try {
      ...
      return new JwtObject(
          ...
          objectMapper.convertValue(jsonObject.get("userDto"), UserResponse.class),
          token
      );
  ...
  public JwtSession refreshJwtSession(String refreshToken) {
    ...
    UserResponse userDto = userRepository.findById(userId)
  ...
  private JwtObject generateJwtObject(UserResponse userDto, long tokenValiditySeconds) {
